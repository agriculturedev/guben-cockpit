...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    E_ID: Attribute.BigInteger;
    eventId: Attribute.BigInteger;
    terminId: Attribute.BigInteger;
...
export interface ApiEventViewEventView extends Schema.SingleType {
  collectionName: 'event_views';
  info: {
    singularName: 'event-view';
    pluralName: 'event-views';
...
export interface ApiHomeViewHomeView extends Schema.SingleType {
  collectionName: 'home_views';
  info: {
    singularName: 'home-view';
    pluralName: 'home-views';
...
export interface ApiOverviewTabOverviewTab extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cards: Attribute.DynamicZone<['cards.information-card-variant1']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProjectViewProjectView extends Schema.SingleType {
  ...
  attributes: {
    ...
    InfoFromAdmin: Attribute.DynamicZone<['generic.button']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
