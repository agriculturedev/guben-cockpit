...
public static class DateTimeExtensions
{
    ...
    public static bool IsWithin(this DateTime datetime, DateTime datetimeFrom, DateTime datetimeUntil, bool inclusive = false)
    {
        return datetime.IsLargerThan(datetimeFrom, inclusive) && datetime.IsSmallerThan(datetimeUntil, inclusive);
    }

    public static bool IsWithin(this DateTime datetime, DateOnly dateonlyFrom, DateOnly dateonlyUntil, bool inclusive = false)
    {
    ...
    {
        return datetime.IsLargerThan(datetimeoffsetFrom, inclusive) && datetime.IsSmallerThan(datetimeoffsetUntil, inclusive);
    }
}