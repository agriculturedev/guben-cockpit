...
public static class DateTimeOffsetExtensions
{
    ...
    public static bool IsLargerThan(this DateTimeOffset datetimeoffset, DateTimeOffset datetimeoffset2, bool inclusive = false)
    {
    ...
    public static bool IsSmallerThan(this DateTimeOffset datetimeoffset, DateTimeOffset datetimeoffset2, bool inclusive = false)
    {
        return datetimeoffset < datetimeoffset2 || (inclusive && datetimeoffset == datetimeoffset2);
    }
    ...
    {
        return datetimeoffset.IsLargerThan(datetimeoffsetFrom, inclusive) && datetimeoffset.IsSmallerThan(datetimeoffsetUntil, inclusive);
    }

    public static bool IsWithin(this DateTimeOffset datetimeoffset, DateOnly dateonlyFrom, DateOnly dateonlyUntil, bool inclusive = false)
    {
        return datetimeoffset.IsLargerThan(dateonlyFrom, inclusive) && datetimeoffset.IsSmallerThan(dateonlyUntil, inclusive);
    }

    public static bool IsWithin(this DateTimeOffset datetimeoffset, DateTime datetimeFrom, DateTime datetimeUntil, bool inclusive = false)
    {
        return datetimeoffset.IsLargerThan(datetimeFrom, inclusive) && datetimeoffset.IsSmallerThan(datetimeUntil, inclusive);
    }
}