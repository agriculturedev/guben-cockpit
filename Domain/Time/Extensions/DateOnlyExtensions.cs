...
public static class DateOnlyExtensions
{
    ...
    {
        return date > new DateOnly(datetime.Year, datetime.Month, datetime.Day) || (inclusive && date == new DateOnly(datetime.Year, datetime.Month, datetime.Day));
    }

    public static bool IsLargerThan(this DateOnly date, DateTimeOffset datetimeoffset, bool inclusive = false)
    {
        return date > new DateOnly(datetimeoffset.Year, datetimeoffset.Month, datetimeoffset.Day) || (inclusive && date == new DateOnly(datetimeoffset.Year, datetimeoffset.Month, datetimeoffset.Day));
    }
