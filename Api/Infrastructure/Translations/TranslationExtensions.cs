...
public static class TranslationExtensions
{
  ...
  /// </summary>
  public static T? GetTranslation<T>(this Dictionary<string, T> translations, CultureInfo cultureInfo)
    where T : class
  {
    if (translations.TryGetValue(cultureInfo.TwoLetterISOLanguageName, out var translation))
      return translation;
