  ...
  where TContext : DbContext
{
  ...
  // used in project and user repo to apply default filters like Published or to filter out system user
  protected IQueryable<TEntity> ModifiedSet { get; set; }
  ...
  public Task<TProjection?> GetNonTrackingProjected<TProjection>(TKey id,
  ...
  public Task<TProjection?> GetNonTrackingSplitQueryProjected<TProjection>(TKey id,
    Expression<Func<TEntity, TProjection>> projection)
  {
    return ModifiedSet
  ...
  public Task<List<TProjection>> GetAllNonTrackingProjected<TProjection>(
    Expression<Func<TEntity, TProjection>> projection)
  {
    return ModifiedSet
  ...
  public Task<List<TProjection>> GetAllNonTrackingSplitQueryProjected<TProjection>(
    Expression<Func<TEntity, TProjection>> projection)
  {
    return ModifiedSet
