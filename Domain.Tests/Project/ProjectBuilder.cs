...
public class ProjectBuilder
{
  ...
  {
    var (result, project) = Projects.Project.Create(_id, _title, _description, _fullText, _imageCaption, _imageUrl, _imageCredits, _createdBy);
    if (result.IsFailure)
  ...
  {
    var (result, project) = Projects.Project.CreateWithGeneratedId(_title, _description, _fullText, _imageCaption, _imageUrl, _imageCredits, _createdBy);
    if (result.IsFailure)
      throw new ArgumentException(result.ToString());
